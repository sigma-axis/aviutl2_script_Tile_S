...
---$color:内部色1
local col_inner1 = 0x404040

---$color:色2
local col2 = 0xe0e0e0

---$color:内部色2
local col_inner2 = 0x202020
...
limit_tiles = math.min(math.max(math.floor(0.5 + limit_tiles), 0), 1);
for i = 1, #fig do
	local f = fig[i];
...
if limit_tiles == 0 then fig[2], fig[3] = fig[1], fig[1] end
